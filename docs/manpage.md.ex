% simple-pwgen(SECTION) | User Commands
%
% "May 29 2022"
...
simple-pwgen - program to do something

# SYNOPSIS

**simple-pwgen** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**simple-pwgen** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **simple-pwgen** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**simple-pwgen** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    simple-pwgen. See **foo.conf**(5) for further details.
...
**simple-pwgen** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Himadri Sekhar Basu
